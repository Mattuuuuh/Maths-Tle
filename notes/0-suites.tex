...
\exe{, difficulty=2}{
	On souhaite étudier la série de Bâle\footnote{Notamment étudiée par Jacques Bernoulli (165?-1705), mathématicien et physicien suisse né à Bâle.} $S_n = \sum\limits_{k=1}^n \dfrac{1}{k^2}$. 
...
\nt{
	Euler\footnote{Leonhard Euler (1707-1783), mathématicien et physicien suisse né à Bâle.} démontra (plus ou moins rigoureusement) en 1735 que
