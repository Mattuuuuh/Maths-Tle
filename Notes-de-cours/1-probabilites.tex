...
\section{Arbres de probabilité et théorème de Bayes}
...
\nt{
	Dans l'exercice \ref{exe:proba1}, on calcule $P(A\cap B)$ en multipliant $P(A) \times P(B \sct A)$ en connaissant ces deux dernières probabilités
	
	Réciproquement, il suit que $P(B \sct A)$ doit être égal à $\frac{P(A \cap B)}{P(A)}$, relation qui devient définition.
}

\dfn{probabilité conditionnelle}{
	On pose la \emphindex{probabilité conditionnelle} de $A$ sachant $B$ par
...
% chiant, vu par l'exemple
%\subsection{Formule des probabilités totales}
%
%\dfn{partition}{
%	Des événements $E_1, E_2, E_3, \dots$ forment une \emphindex{partition} de l'univers $\Omega$ dès que
%		\begin{enumerate}
...
%}{dfn:partition}
%
%\thm{formule des probabilités totales}{
%	Si $E_1, E_2, \dots$ partitionnent l'univers $\Omega$, alors
%		\[ P(A) = P(A\cap E_1) + P(A\cap E_2 ) + P(A\cap E_3) + \cdots. \]
%}{thm:p-totales}
