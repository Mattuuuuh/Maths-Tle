...
\exe{}{
	...
	Il semblerait que $v_n = n+3$ pour tout $n\in\N$.
}
...
\ex{}{
	La suite $u_n = 2n$ est arithmétique de raison 2 car $u_{n+1} = 2(n+1) = 2n + 2 = u_n + 2$ pour tout $n\in\N$.
}{ex:suite-ar}
...
\lem{}{
	\[ \sum_{k=a}^{b} k = (b-a+1)\cdot\dfrac{a+b}2. \]
}{lem:somme-arithm}
