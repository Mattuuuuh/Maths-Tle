...
\begin{figure}[h!]
	...
	\begin{tikzpicture}[>=stealth]
		\begin{axis}[xmin = 0, xmax=100, ymin=-3.1, ymax=3, axis x line=middle, axis y line=middle, axis line style=->, grid=both, clip=true, x=5pt, extra x ticks = {0}, ytick distance = 1]
